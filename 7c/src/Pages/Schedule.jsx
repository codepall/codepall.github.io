...
const Schedule = () => {
    ...
    piketGroup = [
        ["Shelyn", "Shifa", "Andi", "Qilya", "Keyzo", "Zura"],
        ["Naufal", "Juan", "Aziz", "Raffael", "Akhdan", "Andra"],
        ["Esha", "Abid", "Tita", "Chaka", "Lionel","Dina"],
        ["Meilda", "Nazhar", "Rheyhan", "EL", "Deva","Rifqi"],
        ["Dea", "Resa", "Sarah", "Asta", "Manda", "Sofia"],
    ]
